...
describe("url", function() {
  ...
  test(
    "font face with url",
    "@font-face { src: url('My-Font.woff2') format('woff2') }",
    [[1, "@font-face { src: url({./My-Font.woff2}) format('woff2') }", ""]],
    ""
  );
  test(
    "font face with url and query and fragment identifier",
    "@font-face { src: url('webfont.eot?#iefix') format('embedded-opentype') }",
    [
      [
        1,
        "@font-face { src: url({./webfont.eot}?#iefix) format('embedded-opentype') }",
  ...
  test(
    "font face with url and fragment identifier",
    "@font-face { src: url('webfont.svg#svgFontName') format('svg') }",
    [
      [
        1,
        "@font-face { src: url({./webfont.svg}#svgFontName) format('svg') }",

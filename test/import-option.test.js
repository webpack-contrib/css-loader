...
describe('"import" option', () => {
  ...
  it('should work with a modules.auto equal "false" (default)', async () => {
    const compiler = getCompiler('./import/modules.js', {
      modules: {
        auto: false,
      },
    });
    ...
    expect(
      getModuleSource('./import/relative.modules.css', stats)

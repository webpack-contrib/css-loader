	...
	processCss(content, map, {
		...
		var importJs = result.importItems.filter(function(imp) {
			...
			if(!loaderUtils.isUrlRequest(imp.url, root)) {
				...
				return "exports.i(require(" + loaderUtils.stringifyRequest(this, imp.url) + "), " + JSON.stringify(imp.mediaQuery) + ");";
			}
		}, this).join("\n");
		...
		function importItemMatcher(item) {
			...
			return "\" + require(" + loaderUtils.stringifyRequest(this, importItem.url) + ").locals" +
